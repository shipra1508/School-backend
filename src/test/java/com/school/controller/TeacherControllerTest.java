package com.school.controller;
	...
	class TeacherControllerTest {
	    ...
	    void shouldAddTeacherSuccessfully() throws Exception {
	        ...
	        Mockito.when(teacherService.createTeacher(Mockito.any(TeacherDTO.class)))
	    ...
	    void shouldUpdateTeacherSuccessfully() throws Exception {
	        ...
	        Mockito.when(teacherService.updateTeacher(Mockito.eq(1), Mockito.any(TeacherDTO.class)))
	               .thenReturn(teacherDTO);
